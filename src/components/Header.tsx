...
const Header = () => {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-sm transition-all duration-300">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex items-center">
            <img src="/lovable-uploads/82e2e541-f2e0-4589-83d0-4d68efbd9d96.png" alt="Emmy Store Logo" className="h-10 w-auto" />
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && <nav className="md:hidden py-4 border-t border-gray-200">
            ...
            setIsMenuOpen(false);
          }} className="metallic-button text-white px-6 py-2 rounded-full font-inter font-semibold text-center">
                Contato
              </button>
            </div>
          </nav>}
